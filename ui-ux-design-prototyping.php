        ...
        <div class="container position-relative">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center pt-5 mt-3">
                    ...
                    <div class="display-4 fw-bold mb--md-4 mb-3 text-gradient hero-header-text">UI/UX Design & Prototyping</div>
                    <p class="fs-4 text-white text-opacity-70 mb-md-5 mb-3 hero-para-text">Design-first approach for modern and intuitive interfaces</p>
                    ...
                    <div class="d-flex flex-column flex-md-row gap-3 justify-content-center mb-md-5 mb-4">
                        <div
                            ...
                            <span class="fw-semibold fs-5 hero-header-pricing-text">Starting from ₹10,000</span>
                        </div>
                        <div
                            class="d-flex align-items-center gap-3 bg-glass px-4 py-3 rounded-3 border border-white border-opacity-10 hero-header-pricing">
                            <div class="bg-accent bg-opacity-20 rounded-2 d-flex align-items-center justify-content-center"
                            ...
                            <span class="fw-semibold fs-5 hero-header-pricing-text">5-10 days</span>
                        </div>
                    </div>
    ...
    <section class="bg-white section-padding-80px">
        <div class="container">
            <div class="row">
                ...
                <p class="web-design-page-mumbai text-center">Create beautiful, user-friendly interfaces that engage your audience. Our design process focuses on user experience, accessibility, and modern design principles.</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="card h-100 border-0 shadow pricing-card-hovv">
                        <div class="card-body p-4">
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Basic Design</h3>
                            <div class="text-center mb-md-4 mb-2">
                                <div class="display-5 fw-bold text-accent mb-2 pricing-price-design-company">₹10,000</div>
                ...
                <div class="col-lg-4 col-md-6 col-12 mt-md-4 mt-5">
                    <div class="card h-100 border-0 shadow popular-card pricing-card-hovv">
                        ...
                        <div class="card-body p-4 mt-4">
                            ...
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Advanced Design</h3>
                            <div class="text-center mb-md-4 mb-2">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="card h-100 border-0 shadow pricing-card-hovv">
                        <div class="card-body p-4">
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Complete Design</h3>
                            <div class="text-center mb-md-4 mb-2">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-start gap-3 mb-md-3 mb-0">
                                <i class="bi-check-circle text-accent mt-0"></i>
                                <span>Figma or Adobe XD UI Design</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-start gap-3 mb-md-3 mb-0">
                                <i class="bi-check-circle text-accent mt-0"></i>
                                <span>Color & Font Strategy</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-start gap-3 mb-md-3 mb-0">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-5">
                        <span class="badge-tech badge">Figma</span>
                        <span class="badge-tech badge">Adobe XD</span>
                        <span class="badge-tech badge">Sketch</span>
                        <span class="badge-tech badge">Lottie</span>
                        <span class="badge-tech badge">Zeplin</span>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-2 col-6 text-center">
                    ...
                    <h3 class="h5 fw-semibold mb-2">Research</h3>
                    <p class="text-muted small">Understand users, goals, and requirements</p>
                </div>
                <div class="col-md-2 col-6 text-center">
                    <div
                        class="accent-gradient rounded-circle process-step d-flex align-items-center justify-content-center mx-auto mb-3">
                    ...
                    <h3 class="h5 fw-semibold mb-2">Wireframes</h3>
                    <p class="text-muted small">Create layout and structure wireframes</p>
                </div>
                <div class="col-md-2 col-6 text-center">
                    <div
                        class="accent-gradient rounded-circle process-step d-flex align-items-center justify-content-center mx-auto mb-3">
                    ...
                    <p class="text-muted small">Design beautiful and functional interfaces</p>
                </div>
                <div class="col-md-2 col-6 text-center">
                    <div
                        class="accent-gradient rounded-circle process-step d-flex align-items-center justify-content-center mx-auto mb-3">
                    ...
                    <h3 class="h5 fw-semibold mb-2">Prototype</h3>
                    <p class="text-muted small">Create interactive prototypes</p>
                </div>
                <div class="col-md-2 col-6 text-center">
                    <div
                        class="accent-gradient rounded-circle process-step d-flex align-items-center justify-content-center mx-auto mb-3">
                    ...
                    <p class="text-muted small">User testing and design refinement</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="card faq-card mb-4 border-0">
                        <div class="card-body p-4">
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    <h3 class="h5 fw-semibold mb-3">Do you provide the design files?</h3>
                                    <p class="text-muted">
                                        Yes, we provide all design files in Figma or Adobe XD format, along with assets and specifications.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card faq-card mb-4 border-0">
                        <div class="card-body p-4">
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    <h3 class="h5 fw-semibold mb-3">Can you design for mobile apps?
                                    </h3>
                                    <p class="text-muted">
                                      Yes, we design for web, mobile apps, and responsive interfaces across all devices.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card faq-card mb-4 border-0">
                        <div class="card-body p-4">
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    <h3 class="h5 fw-semibold mb-3">Do you conduct user testing?</h3>
                                    <p class="text-muted">
                                        Yes, we can conduct user testing sessions to validate designs and improve user experience.
                                    </p>
                                </div>
                            </div>
                        </div>
