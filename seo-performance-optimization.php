        ...
        <div class="container position-relative">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center pt-5 mt-3">
                    ...
                    <div class="display-4 fw-bold mb--md-4 mb-3 text-gradient hero-header-text">SEO & Performance Optimization</div>
                    <p class="fs-4 text-white text-opacity-70 mb-md-5 mb-3 hero-para-text">Complete SEO audit and performance enhancement</p>
                    ...
                    <div class="d-flex flex-column flex-md-row gap-3 justify-content-center mb-md-5 mb-4">
                        <div
                            ...
                            <span class="fw-semibold fs-5 hero-header-pricing-text">Starting from ₹20,000</span>
                        </div>
                        <div
                            class="d-flex align-items-center gap-3 bg-glass px-4 py-3 rounded-3 border border-white border-opacity-10 hero-header-pricing">
                            <div class="bg-accent bg-opacity-20 rounded-2 d-flex align-items-center justify-content-center"
                            ...
                            <span class="fw-semibold fs-5 hero-header-pricing-text">7-14 days</span>
                        </div>
                    </div>
    ...
    <section class="bg-white section-padding-80px">
        <div class="container">
            <div class="row">
                ...
                <p class="web-design-page-mumbai text-center">Improve your website's search engine rankings and performance with our comprehensive SEO and optimization services. We analyze, optimize, and monitor your site for better visibility.</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="card h-100 border-0 shadow pricing-card-hovv">
                        <div class="card-body p-4">
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Basic SEO</h3>
                            <div class="text-center mb-md-4 mb-2">
                                <div class="display-5 fw-bold text-accent mb-2 pricing-price-design-company">₹20,000</div>
                            ...
                            <ul class="list-unstyled mb-4 web-design-page-mumbai-li-hight">
                                ...
                                <li class="d-flex align-items-start gap-2 mb-md-3 mb-0">
                                    <i class="bi-check-circle text-accent mt-0"></i>
                                    <span>Basic technical SEO</span>
                                </li>
                                <li class="d-flex align-items-start gap-2 mb-md-3 mb-0">
                                    <i class="bi-check-circle text-accent mt-0"></i>
                                    <span>2 months monitoring</span>
                                </li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6 col-12 mt-md-4 mt-5">
                    <div class="card h-100 border-0 shadow popular-card pricing-card-hovv">
                        ...
                        <div class="card-body p-4 mt-4">
                            ...
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Advanced SEO</h3>
                            <div class="text-center mb-md-4 mb-2">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="card h-100 border-0 shadow pricing-card-hovv">
                        <div class="card-body p-4">
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Enterprise SEO</h3>
                            <div class="text-center mb-md-4 mb-2">
                                <div class="display-5 fw-bold text-accent mb-2 pricing-price-design-company">₹60,000</div>
                                <p class="text-muted d-flex align-items-center justify-content-center gap-2 pricing-duration-design-company">
                                    <i class="bi-clock"></i>
                                    12-15 days
                                </p>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-5">
                        ...
                        <span class="badge-tech badge">Search Console</span>
                        <span class="badge-tech badge">SEMrush</span>
                        <span class="badge-tech badge">PageSpeed Insights</span>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-2 col-6 text-center">
                    ...
                    <h3 class="h5 fw-semibold mb-2">Audit</h3>
                    <p class="text-muted small">Comprehensive analysis of current SEO status</p>
                </div>
                <div class="col-md-2 col-6 text-center">
                    <div
                        class="accent-gradient rounded-circle process-step d-flex align-items-center justify-content-center mx-auto mb-3">
                    ...
                    <p class="text-muted small">Develop optimization strategy and plan</p>
                </div>
                <div class="col-md-2 col-6 text-center">
                    <div
                        class="accent-gradient rounded-circle process-step d-flex align-items-center justify-content-center mx-auto mb-3">
                    ...
                    <h3 class="h5 fw-semibold mb-2">Implementation</h3>
                    <p class="text-muted small">Apply SEO improvements and optimizations</p>
                </div>
                <div class="col-md-2 col-6 text-center">
                    <div
                        class="accent-gradient rounded-circle process-step d-flex align-items-center justify-content-center mx-auto mb-3">
                    ...
                    <h3 class="h5 fw-semibold mb-2">Monitoring</h3>
                    <p class="text-muted small">Track performance and search rankings</p>
                </div>
                <div class="col-md-2 col-6 text-center">
                    <div
                        class="accent-gradient rounded-circle process-step d-flex align-items-center justify-content-center mx-auto mb-3">
                    ...
                    <p class="text-muted small">Continuous improvement and fine-tuning</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="card faq-card mb-4 border-0">
                        <div class="card-body p-4">
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    <h3 class="h5 fw-semibold mb-3">How long does it take to see SEO results?</h3>
                                    <p class="text-muted">
                                       SEO improvements typically take 3-6 months to show significant results, depending on competition and current site status.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card faq-card mb-4 border-0">
                        <div class="card-body p-4">
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    <h3 class="h5 fw-semibold mb-3">Do you guarantee first page rankings?
                                    </h3>
                                    <p class="text-muted">
                                        While we can't guarantee specific rankings, we use proven strategies to significantly improve your search visibility.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card faq-card mb-4 border-0">
                        <div class="card-body p-4">
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    <h3 class="h5 fw-semibold mb-3">What's included in the SEO audit?</h3>
                                    <p class="text-muted">
                                       Our audit covers technical SEO, content analysis, keyword research, competitor analysis, and performance metrics.
                                    </p>
                                </div>
                            </div>
                        </div>
