            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center pt-5 mt-3">
                    <div class="hero-icon-all-web d-inline-flex align-items-center justify-content-center bg-glass rounded-3 border border-white border-opacity-10 mb-4">
                        <i class="bi bi-code text-white fs-1"></i>
                    </div>
                    <div class="display-4 fw-bold mb--md-4 mb-3 text-gradient hero-header-text">Custom Web Applications</div>
                    <p class="fs-4 text-white text-opacity-70 mb-md-5 mb-3 hero-para-text">Scalable web applications built with cutting-edge frameworks</p>
                    ...
                    <div class="d-flex flex-column flex-md-row gap-3 justify-content-center mb-md-5 mb-4">
                        <div
                            ...
                            <span class="fw-semibold fs-5 hero-header-pricing-text">Starting from ₹75,000</span>
                        </div>
                        <div
                            class="d-flex align-items-center gap-3 bg-glass px-4 py-3 rounded-3 border border-white border-opacity-10 hero-header-pricing">
                            <div class="bg-accent bg-opacity-20 rounded-2 d-flex align-items-center justify-content-center"
                            ...
                            <span class="fw-semibold fs-5 hero-header-pricing-text">20-40 days</span>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="card h-100 border-0 shadow pricing-card-hovv">
                        <div class="card-body p-4">
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Basic App</h3>
                ...
                <div class="col-lg-4 col-md-6 col-12 mt-md-4 mt-5">
                    <div class="card h-100 border-0 shadow popular-card pricing-card-hovv">
                        ...
                        <div class="card-body p-4 mt-4">
                            ...
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Advanced App</h3>
                            <div class="text-center mb-md-4 mb-2">
                                <div class="display-5 fw-bold text-accent mb-2 pricing-price-design-company">₹1,50,000</div>
                                <p class="text-muted d-flex align-items-center justify-content-center gap-2 pricing-duration-design-company">
                                    <i class="bi-clock"></i>
                                    30-35 days
                                </p>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="card h-100 border-0 shadow pricing-card-hovv">
                        <div class="card-body p-4">
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Enterprise App</h3>
                            <div class="text-center mb-md-4 mb-2">
                                <div class="display-5 fw-bold text-accent mb-2 pricing-price-design-company">₹3,00,000</div>
                                <p class="text-muted d-flex align-items-center justify-content-center gap-2 pricing-duration-design-company">
                                    <i class="bi-clock"></i>
                                    40-60 days
                                </p>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-5">
                        ...
                        <span class="badge-tech badge">PostgreSQL</span>
        ...
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-2 col-6 text-center">
                    ...
                    <h3 class="h5 fw-semibold mb-2">Analysis</h3>
                    <p class="text-muted small">Understand business requirements and technical needs</p>
                </div>
                <div class="col-md-2 col-6 text-center">
                    <div
                        class="accent-gradient rounded-circle process-step d-flex align-items-center justify-content-center mx-auto mb-3">
                    ...
                    <h3 class="h5 fw-semibold mb-2">Architecture</h3>
                    <p class="text-muted small">Design scalable system architecture</p>
                </div>
                <div class="col-md-2 col-6 text-center">
                    <div
                        class="accent-gradient rounded-circle process-step d-flex align-items-center justify-content-center mx-auto mb-3">
                ...
                <div class="col-md-2 col-6 text-center">
                    ...
                    <p class="text-muted small">Deploy to cloud with monitoring and support</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="card faq-card mb-4 border-0">
                        <div class="card-body p-4">
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    <h3 class="h5 fw-semibold mb-3">What types of web applications do you build?</h3>
                                    <p class="text-muted">
                                        We build all types including CRM systems, inventory management, booking systems, and custom business tools.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card faq-card mb-4 border-0">
                        <div class="card-body p-4">
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    <h3 class="h5 fw-semibold mb-3">How do you ensure scalability?
                                    </h3>
                                    <p class="text-muted">
                                        We use modern architectures, cloud services, and best practices to ensure your application can grow with your business.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card faq-card mb-4 border-0">
                        <div class="card-body p-4">
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    <h3 class="h5 fw-semibold mb-3">Do you provide ongoing maintenance?</h3>
                                    <p class="text-muted">
                                        Yes, we offer comprehensive maintenance packages including updates, security monitoring, and feature additions.
                                    </p>
                                </div>
                            </div>
                        </div>
