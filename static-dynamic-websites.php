                ...
                <div class="col-lg-8 text-center pt-5 mt-3">
                    ...
                    <div class="d-flex flex-column flex-md-row gap-3 justify-content-center mb-md-5 mb-4">
                        <div
                            ...
                            <span class="fw-semibold fs-5 hero-header-pricing-text">Starting from ₹15,000</span>
                        </div>
                        <div
                            class="d-flex align-items-center gap-3 bg-glass px-4 py-3 rounded-3 border border-white border-opacity-10 hero-header-pricing">
                            <div class="bg-accent bg-opacity-20 rounded-2 d-flex align-items-center justify-content-center"
    ...
    <section class="bg-white section-padding-80px">
        <div class="container">
            <div class="row">
                ...
                <p class="web-design-page-mumbai text-center">We create fast-loading, responsive websites that deliver exceptional user experiences across all devices. Our websites are built with modern frameworks and optimized for performance, SEO, and conversion.</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="card h-100 border-0 shadow pricing-card-hovv">
                        <div class="card-body p-4">
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Basic Package</h3>
                            <div class="text-center mb-md-4 mb-2">
                                <div class="display-5 fw-bold text-accent mb-2 pricing-price-design-company">₹15,000</div>
                ...
                <div class="col-lg-4 col-md-6 col-12 mt-md-4 mt-5">
                    <div class="card h-100 border-0 shadow popular-card pricing-card-hovv">
                        ...
                        <div class="card-body p-4 mt-4">
                            ...
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Standard Package</h3>
                            <div class="text-center mb-md-4 mb-2">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="card h-100 border-0 shadow pricing-card-hovv">
                        <div class="card-body p-4">
                            <h3 class="h3 fw-bold text-center mb-md-2 mb-1 pricing-heading-design-company">Premium Package</h3>
                            <div class="text-center mb-md-4 mb-2">
                    ...
                    <div class="card faq-card mb-4 border-0">
                        <div class="card-body p-4">
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    <h3 class="h5 fw-semibold mb-3">Do you provide hosting?
                                    </h3>
                                    <p class="text-muted">
                                       We can recommend and set up hosting solutions, or work with your existing hosting provider.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card faq-card mb-4 border-0">
                        <div class="card-body p-4">
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    <h3 class="h5 fw-semibold mb-3">Will my website be mobile-friendly?</h3>
                                    <p class="text-muted">
